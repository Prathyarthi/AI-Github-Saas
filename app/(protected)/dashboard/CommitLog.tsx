...
// import { getCommitLogs } from "@/lib/actions/projects.actions"
...
//     const commits = await getCommitLogs(selectedProject!)

//     return (
//         <>
//             <ul className="space-y-6">
//                 {commits?.map((commit: any, commitIndex: any) => (
...
//                         <>
//                             <img src={commit.commitAvatar} alt="avatar" className="relative mt-4 size-8 flex-none rounded-full bg-gray-500" />
